    ...
    <>
      ...
      <div className="review-container profile-container">
        ...
        <div className="reviewer-info profile-info">
          ...
          >
            sajolhowlader08@gmail.com
          </a>
        </div>
        <div>
          <p className="text-center text-3xl font-bold text-blue-700 my-8">
            EDUCATION
          </p>
          ...
          <div>
            <a
              className="text-center font-bold text-lg text-green-900 block"
            ...
            <a
              className="text-center font-bold text-lg text-green-900 block mb-16"
              href=" https://sajalhowlader.github.io/Toing-web/"
            >
              TOING
            </a>
          </div>
